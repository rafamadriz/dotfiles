...
gls.left[6] = {
    GitIcon = {
        provider = function()
            if require("galaxyline.provider_vcs").check_git_workspace and wide_enough(85) then
                return "   "
            end
            return ""
        end,
...
gls.left[8] = {
    DiffAdd = {
        provider = function()
            if require("galaxyline.provider_vcs").check_git_workspace and wide_enough(95) then
                return vcs.diff_add()
            end
            return ""
        end,
