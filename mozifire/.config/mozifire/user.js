...
user_pref('general.smoothScroll.mouseWheel.durationMinMS', 500);
user_pref('general.smoothScroll.mouseWheel.migrationPercent', 0);
user_pref('general.smoothScroll.msdPhysics.continuousMotionMaxDeltaMS', 1000);
...
// breaks some websites bracsue of cloudflare JS Challenge, e.g Gitlab login page
