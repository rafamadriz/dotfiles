...
while getopts ":a:r:b:p:h" o; do case "${o}" in
    ...
    message\\n" && exit 1 ;; r)
        dotfilesrepo=${OPTARG} && git ls-remote
        "$dotfilesrepo" || exit 1
        ;;
    b) repobranch=${OPTARG} ;;
    p) progsfile=${OPTARG} ;;
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/rafamadriz/dotfiles"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/rafamadriz/dotfiles/main/.local/share/rais/testing/progs.csv"
...
welcomemsg() {
    dialog --title "Welcome!" --msgbox "Welcome to Luke's Auto-Rice
    Bootstrapping Script!\\n\\nThis script will automatically install a
    fully-featured Linux desktop, which I use as my main machine.\\n\\n-Luke"
    10 60
