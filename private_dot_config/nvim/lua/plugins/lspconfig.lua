...
local set_mappings = function(client, bufnr)
    ...
    as.nnoremap('<leader>lwa', vim.lsp.buf.add_workspace_folder, with_desc "Add folder to workspace")
    as.nnoremap('<leader>lwr', vim.lsp.buf.remove_workspace_folder, with_desc "Remove folder from workspace")
    as.nnoremap('<leader>lwl', function() print(vim.inspect(vim.lsp.buf.list_workspace_folders())) end, with_desc "List workspace folders")
