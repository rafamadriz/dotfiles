...
as.onoremap(
    "f",
    function() hop.hint_char1 { direction = after, current_line_only = true, inclusive_jump = true } end
)
as.onoremap(
    "F",
    function() hop.hint_char1 { direction = before, current_line_only = true, inclusive_jump = true } end
)
